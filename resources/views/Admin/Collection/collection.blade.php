                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-4 p-0" style="padding:0px;">
                                Collection<span class="table-project-n"></span> Table
                            </h1>
                            ...
                            {{--  <button type="button" class="btn btn-info col-lg-2 Primary" 
                                ...
                                data-target="#PrimaryModalalert">Add Collection
                            </button>  --}}
                        </div>
                    </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                <select name="customer" class="form-control CUST" required>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                <select name="invoice" class="form-control invoice" required>
                                                    <option value="null">--- Select Sale Invoice ---</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                <input name="due" class="form-control due" readonly/>
                                                <input name="paid" type="hidden" class="paid"/>
                                                <input name="delivery" type="hidden" class="delivery"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group-inner">
                    ...
                    <div class="modal modal-adminpro-general default-popup-PrimaryModal fade" 
                        ...
                        <div class="modal-dialog">
                            ...
                            <form id="updatE">@csrf
                                ...
                                <div class="modal-header header-color-modal bg-color-1">
                                    <h4 class="modal-title">Edit Collection Info</h4>
                                </div>
                                <div class="modal-body">
                                    ...
                                    {{-- <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                <input type="customer" class="form-control Custt" required/>
                                            </div>
                                        </div>
                                    </div> --}}
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                <input type="text" class="form-control Invoice" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group-inner">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                <input type="text" class="form-control Amt" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group-inner">
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="custo" data-editable="false">Customer</th>
                                        {{--  <th data-field="deliver" data-editable="false">Delivery</th>  --}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="datatable-ct">
                                            <button type="button" value="{{ $data->id }}"
                                                class="btn btn-primary eddit btn-xs" data-toggle="modal" 
...
<script>
    $(document).ready(function () {
        $('.eddit').on('click', function () {
            var id = $(this).val();
            $.ajax({
                type: "GET",
                url: "{{ route('collection.edit') }}",
                data: {id: id},
                success: function (data) {
                    $('.id').val(data[0]['id']);
                    $('.Date').val(data[0]['date']);
                    $('.Custt').val(data[0]['customer']);
...
<script type="text/javascript">
        ...
        jQuery('select[name="customer"]').on('change',function(){
            ...
            if(id) {
                jQuery.ajax({
                    ...
                    success:function(data) {
                    console.log(data);
                    jQuery('select[name="invoice"]').empty();
                    jQuery.each(data, function(key,value){
                        $('select[name="invoice"]').append('<option value="'+ value +'">'+ value +'</option>');
                    });
                    }
                });
            } else {
    ...
    $('.invoice').on('click', function () {
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('collection.due') }}",
            data: {id: id},
            success: function (data) {
                $('.due').val(data[0]['due']);
                $('.paid').val(data[0]['paid']);
                $('.delivery').val(data[0]['delivery']);
            }
        });
    });
