                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-4 p-0" style="padding:0px;">
                                Parking Zone<span class="table-project-n"></span> List
                            </h1>
                            ...
                            <button type="button" class="btn btn-info col-lg-2 Primary" style="float:right;" 
                                data-toggle="modal" data-target="#PrimaryModalalert">Add Parking Zone
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            ...
                            <form action="{{ route('delivery.store') }}" method="POST">
                                ...
                                <div class="modal-header header-color-modal bg-color-1">
                                    <h4 class="modal-title">Add Parking Zone Info</h4>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label class="login2 pull-right pull-right-pro">
                                                    Limit <span class="table-project-n">*</span>
                                                </label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label class="login2 pull-right pull-right-pro">
                                                    Space <span class="table-project-n">*</span>
                                                </label>
                                            </div>
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                <input type="number" name="limit" 
                                                    class="limit form-control" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                <input type="number" name="space" 
                                                    class="space form-control" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                <textarea type="text" name="note"
                                                    class="note form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="limit" data-editable="false">Limit</th>
                                        <th data-field="space" data-editable="false">Space</th>
