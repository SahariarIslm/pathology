                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-4 p-0" style="padding:0px;">
                                Expense Type<span class="table-project-n"></span> Table
                            </h1>
                            ...
                            <button type="button" class="btn btn-info col-lg-2 Primary" 
                                ...
                                data-target="#PrimaryModalalert">Add Expense Type
                            </button>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="datatable-ct">
                                            ...
                                            @if($data->status == "1")
                                                <a href="{{route('expense.type.status',['id'=>$data->id])}}" 
                                                    class="btn btn-warning btn-xs"
                                                    onclick="return confirm('Are You Sure ??')">
                                                    <i class="fa fa-arrow-down" 
                                                    title="Change Status to Inactive ??"></i>
                                                </a>
                                            @elseif($data->status == "0")
                                                <a href="{{route('expense.type.status',['id'=>$data->id])}}" 
                                                    ...
                                                    title="Change Status to Active ??"></i>
                                                </a>
                                            @endif
                                        </td>
                                    </tr>
