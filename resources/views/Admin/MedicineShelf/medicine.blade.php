                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-4 p-0" style="padding:0px;">
                                Medicine Shelves<span class="table-project-n"></span> List
                            </h1>
                            ...
                            <button type="button" class="btn btn-info col-lg-2 Primary" style="float:right;" 
                                data-toggle="modal" data-target="#PrimaryModalalert">Add Medicine Shelves
                            </button>
                            @endcan
                        </div>
                    </div>
                    ...
                    <div id="PrimaryModalalert" class="modal modal-adminpro-general default-popup-PrimaryModal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <form action="{{ route('medicine_shelf.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="modal-header header-color-modal bg-color-1">
                                    <h4 class="modal-title">Add Medicine Shelves Info</h4>
                                </div>
                    ...
                    <div id="InformationproModalhdbgcl" class="modal modal-adminpro-general default-popup-PrimaryModal fade" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header header-color-modal bg-color-1">
                                    <h4 class="modal-title">Edit Medicine Shelves</h4>
                                    <div class="modal-close-area modal-close-df">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="datatable-ct">
                                            ...
                                            @if($data->status == "1")
                                                <a href="{{route('medicine_shelf.status',['id'=>$data->id])}}" 
                                            ...
                                            @can('admin')
                                            <form action="{{ route('medicine_shelf.destroy', $data->id)}}" method="post" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
...
<script>
    $(document).ready(function () {
        ...
        $('#updatE').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('medicine_shelf.update') }}",
                data: {
