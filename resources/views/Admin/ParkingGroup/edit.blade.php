                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="all-form-element-inner">
                                        <form action="{{ route('parking_group.update',$data->id) }}" method="POST" id="myForm">
                                            @csrf
                                            <div class="sparkline12-list col-md-12">
                                                ...
                                                <div class="sparkline13-hd">
                                                    <div class="main-sparkline13-hd">
                                                        ...
                                                        <a class="btn btn-danger col-sm-3 Primary" style="margin-left: 5px; float: right;" href="{{ route('parking_group.index') }}" role="button">Go Back </a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
