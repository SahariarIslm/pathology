                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="all-form-element-inner">
                                        <form action="{{ route('parking_price.update',$data->id) }}" method="POST" id="myForm">
                                            @csrf
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <select class="form-control custom-select-value" name="delivery_id">
                                                                    ...
                                                                    @foreach($parkingZones as $parkingZone)
                                                                        <option {{$parkingZone->id == $data->delivery_id ? 'selected' : ''}} value="{{ $parkingZone->id }}">
                                                                            {{ $parkingZone->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <select class="form-control custom-select-value" name="vehicle_category_id">
                                                                    ...
                                                                    @foreach($vehicleTypes as $vehicleType)
                                                                        <option {{$vehicleType->id == $data->vehicle_category_id ? 'selected' : ''}} value="{{ $vehicleType->id }}">
                                                                            {{ $vehicleType->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <select class="form-control custom-select-value" name="parking_group_id">
                                                                    ...
                                                                    @foreach($parkingGroups as $parkingGroup)
                                                                        <option {{$parkingGroup->id == $data->parking_group_id ? 'selected' : ''}} value="{{ $parkingGroup->id }}">
                                                                            {{ $parkingGroup->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="numbe" name="price" class="form-control" value="{{$data->price}}" placeholder="Please enter price rate">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="numbe" name="penalty" class="form-control" value="{{$data->penalty}}" placeholder="Please enter Penalty rate">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
