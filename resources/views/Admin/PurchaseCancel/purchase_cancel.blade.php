                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-4 p-0" style="padding:0px;">
                                Purchase<span class="table-project-n"></span> Cancel
                            </h1>
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="date" data-editable="false">Purchase Date</th>
                                        <th data-field="supplie" data-editable="false">Supplier</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="datatable-ct">
                                            <a href="{{ route('purchase.cancel.details',['id'=>$data->purchase_no]) }}" 
