                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-3" style="padding:0px;">
                                Collection Report <small>( Date Wise )</small>
                            </h1>
                            <form action="{{ route('collection.report.print_datewise') }}" method="get"
                            ...
                            <form action="{{ route('collection.report.datewise') }}" method="get">
                                {{ csrf_field() }}
                                <div class="col-lg-4">
                                    <div class="row">
                                        <div class="col-lg-3">
