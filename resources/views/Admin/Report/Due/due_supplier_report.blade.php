@extends('Master.main')
@section('title')
    All Supplier Due Report (A/C Payable)
@endsection
@section('content')
...
<div class="data-table-area mg-tb-15">
                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 style="float: left;">All Supplier Due Report <small>(A/C Payable)</span></h1>
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="suppli" data-editable="false">Supplier</th>
    ...
    <script>
        $('.Print').click(function () {
            $.ajax({
                url: "{{ route('due.supplier.print') }}",
                type: 'GET',
                success: function (){
                    window.open('{{ route('due.supplier.print') }}','_blank');
                }
            });
        });
    </script>
