                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-3" style="padding:0px;">
                                Purchase Report <small>( Group By Date )</small>
                            </h1>
                            {{-- <a href="{{ route('purchase.report.print_groupby') }}" target="_blank"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="datatable-ct">
                                            <a href="{{ route('purchase.report.groupby.details',
                                                ['id'=>$data->date]) }}" class="btn btn-info btn-xs">
