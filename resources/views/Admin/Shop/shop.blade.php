                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            ...
                            <div class="col-lg-2" style="float:right;">
                                <small>*<span class="grn" style="padding:4px;">7 Days to Expired Date</span></small>
                                <br>
                                <small>*<span class="orng" style="padding:4px;">Date Expired</span></small> 
                            </div>
                        </div>
                    </div>
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="name" data-editable="false">Admin Name</th>
                                        ...
                                        <td class="datatable-ct">
                                            @if($data->status == "Active")
                                                <a href="{{ route('shop.status',['id'=>$data->id])}}" 
                                                    ...
                                                    onclick="return confirm('Are You Sure You Want To Change Shop Status ??')">
                                                    <i class="fa fa-arrow-down" 
                                                    title="Change Shop Status to Inactive ??"></i>
                                                </a>
                                            @elseif($data->status == "Inactive")
                                                <a href="{{ route('shop.status',['id'=>$data->id])}}" 
                                                    ...
                                                    title="Change Shop Status to Active ??"></i>
                                                </a>
                                            @endif
                                        </td>
                                        @endcan
