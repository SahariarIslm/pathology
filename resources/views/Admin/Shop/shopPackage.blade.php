                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="col-lg-4 p-0" style="padding:0px;">
                                Shop Package<span class="table-project-n"></span> Table
                            </h1>
                            ...
                            <button type="button" class="btn btn-info col-lg-2 Primary" style="float:right;" 
                                data-toggle="modal" data-target="#PrimaryModalalert">Add Package
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="PrimaryModalalert" class="modal modal-adminpro-general default-popup-PrimaryModal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <form action="{{ route('shop.package.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="modal-header header-color-modal bg-color-1">
                                    <h4 class="modal-title">Add Shop Package Info</h4>
                                </div>
                    ...
                    <div id="InformationproModalhdbgcl" class="modal modal-adminpro-general default-popup-PrimaryModal fade" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header header-color-modal bg-color-1">
                                    <h4 class="modal-title">Edit Shop Package Info</h4>
                                    <div class="modal-close-area modal-close-df">
                                ...
                                <div class="modal-body">
                                    <div class="form-group-inner">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                <label class="login2 pull-right pull-right-pro">
                                                    Packge Name <span class="table-project-n">*</span>
                                                </label>
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                <input type="text" name="price" 
                                                    class="price form-control" required/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                <input type="text" name="days" 
                                                    class="days form-control" required/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="datatable-ct w-25" style="width:25%;">
                                            ...
                                            @endcan
                                            @if($data->status == "1")
                                                <a href="{{route('shop.package.status',['id'=>$data->id])}}" 
                                                    class="btn btn-warning btn-xs"
                                                    onclick="return confirm('Are You Sure You Want To Change Shop Package Status ??')">
                                                    <i class="fa fa-arrow-down" 
                                                    title="Change Shop Package Status to Inactive ??"></i>
                                                </a>
                                            @elseif($data->status == "0")
                                                <a href="{{route('shop.package.status',['id'=>$data->id])}}" 
                                                    ...
                                                    title="Change Shop Package Status to Active ??"></i>
                                                </a>
                                            @endif
                                        </td>
                                    </tr>
...
<script>
    ...
    $('.deletE').on('click', function () {
        ...
        $.ajax(
            {
                url: "{{ route('shop.package.destroy') }}",
                type: 'GET',
                data: {
                    "id": id,
                },
